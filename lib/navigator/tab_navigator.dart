...
class _TabNavigatorState extends State<TabNavigator>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("我就测试一下"),),
      body: PageView(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          type: BottomNavigationBarType.fixed,//设置显示bar的文字
          items:[
            BottomNavigationBarItem(
                icon: Icon(Icons.home, color: _defaultColor,), //默认的icon
                activeIcon: Icon(Icons.home, color: _activeColor,), //激活的icon
